...
namespace HibaVonal_03.Controllers.Fault
{
    ...
    public class FaultController : ControllerBase
    {
        ...
        {
            var result = await _faultService.UpdateFault(id, fault);
        ...
        {
            var result = await _faultService.NewFeedback(id, dto);
        ...
        {
            var result = _faultService.GetFaultsByStatusAsync(status);
        ...
        public async Task<ActionResult> UpdateFaultStatus(int id, [FromBody] FaultStatus status)
        {
