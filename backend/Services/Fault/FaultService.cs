...
namespace HibaVonal_03.Services.Fault
{
    public class FaultService : IFaultService
    {
        ...
        //Update
        public async Task<bool> UpdateFault(int faultId, FaultUpdateDto fault)
        {
            ...
            }else
            {
                ...
                existingFault.Attachments = fault.Attachments;
        ...
        //Delete
        public async Task<bool> DeleteFault(int faultId)
        {
            var existingFault = await _unitOfWork.FaultRepository.GetByIdAsync(faultId);
        ...
        public async Task<bool> NewFeedback(int id, FeedbackCreateDto dto)
        {
        ...
        public async Task<bool> UpdateFaultStatusAsync(int faultId, FaultStatus status)
        {
            var existingFault = await _unitOfWork.FaultRepository.GetByIdAsync(faultId);
